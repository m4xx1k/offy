...
import { useSourceStats } from "@/hooks/analytics/use-analytics"
import { GlassChartCard, ChartCardSkeleton, ChartTooltip } from "../ui"
import {
	Bar,
	BarChart,
	CartesianGrid,
...
export function SourceStatsChart() {
	...
	if (error) {
		return (
			<GlassChartCard title="Статистика по джерелах">
