...
import { useTopCompanies } from "@/hooks/analytics/use-analytics"
import { CompanyStats } from "@/shared/types/analytics.types"
import {
	createColumnHelper,
	flexRender,
	getCoreRowModel,
...
const columnHelper = createColumnHelper<CompanyStats & { rank: number }>()
...
export function TopCompaniesTable() {
	...
	if (error) {
		return (
			<GlassChartCard title="Топ компаній">
	...
	return (
		<GlassChartCard title="Топ компаній" subtitle="За кількістю вакансій">
