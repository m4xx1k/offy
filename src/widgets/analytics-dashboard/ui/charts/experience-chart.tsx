...
import { useExperienceStats } from "@/entities/analytics";
import { getExperienceColor, getExperienceLabel } from "@/entities/vacancy";
...
export function ExperienceChart() {
  ...
  return (
    <ChartCard title="Досвід роботи" subtitle="Розподіл вимог по рокам">
