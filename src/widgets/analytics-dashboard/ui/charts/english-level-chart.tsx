...
import { useEnglishLevelStats } from "@/entities/analytics";
import { ENGLISH_LEVEL_COLORS, ENGLISH_LEVEL_ORDER } from "@/shared/config/constants";
import { formatEnglishLevel } from "@/entities/vacancy";
import { SimpleChartTooltip } from "@/shared/ui";
...
export function EnglishLevelChart() {
  ...
  const chartData = useMemo(() => {
    ...
    return data
      .map((item) => ({
        name: formatEnglishLevel(item.level, "full"), // Upper-Intermediate, etc.
        count: item.count,
  ...
  return (
    <ChartCard title="English Level" subtitle="Розподіл вимог до мови">
